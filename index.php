<!DOCTYPE HTML>
<!--
	Fractal by HTML5 UP (EDIT again)
	html5up.net | @ajlkn
	Free for personal and commercial use under the CCA 3.0 license (html5up.net/license)
-->
<html>
	<head>
		<title>RedDuct (Under Construction)</title>
		<meta charset="utf-8" />
		...
		<!-- Header -->
			<header id="header">
				<div class="content">
					...
					<ul class="actions">
						<li><a href="mailto:vendor@redduct.com" class="button primary icon solid fa-grin-alt"></i>Amazing! I am in</a></li>
				...
				<div class="inner alt">
					<section class="spotlight">
						...
						<div class="content">
							...
							<p>Your painting or a handicraft have value. So get it directly in Bitcoin. Usually a person needs to work, earn money <a href="https://en.wikipedia.org/wiki/Fiat_money" target="_blank" ></i> (fiat) </a> then hardly exchange it in crypto. This market makes it extremely easy for seller to get Bitcoin.</p>
						</div>
					</section>
					<section class="spotlight">
					...
					<section class="spotlight">
						...
						<div class="content">
							...
							<p>You don't have to deal with all the technical parts. Just log in and upload your information, It's all set. <a href="https://youtu.be/5T8KrDUcsV0" target="_blank" style="color:#4696e5;" ></i> (Watch this video) </a></p>
						</div>
					</section>
		...
		<!-- Three -->
			<section id="three" class="wrapper style2 special">
				...
				<ul class="actions special">
					<li><a href="mailto:vendor@redduct.com?subject=Cool I want to join!&body=This my contract information Name and my email here." class="button primary icon solid fa-grin-alt">Cool I want to join</a></li>
				</ul>
			</section>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					<li><a href="https://twitter.com/DuctRed" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
				</ul>
